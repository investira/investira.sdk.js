...
- [themes] Novo módulo <code>themes</code> com utilitários para derivação de temas a partir de uma cor primária.
- [themes] Nova função <code>buildThemeFromPrimaryColor</code> com suporte a tema para fundo claro e fundo escuro.

# 2.4.38

- [string] Novo metodo toString

# 2.4.37

- [numbers] Novo parametro pNullValue
- [string] Novo parametro pNullValue
- [dates] Novo parametro pNullValue
