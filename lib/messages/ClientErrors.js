...
class ProxyAuthenticationRequiredError extends BasicMessageError {
     ...
     */
    constructor(
        pMessage = 'Proxy Authentication Required',
        pSource = '0',
        pCode = '0'
    ) {
...
class UnsupportedMediaTypeError extends BasicMessageError {
     ...
     */
    constructor(
        pMessage = 'Unsupported Media Type',
        pSource = '0',
        pCode = '0'
    ) {
...
class RequestedRangeNotSatisfiableError extends BasicMessageError {
     ...
     */
    constructor(
        pMessage = 'Requested Range Not Satisfiable',
        pSource = '0',
        pCode = '0'
    ) {
...
class PreconditionRequiredError extends BasicMessageError {
     ...
     */
    constructor(
        pMessage = 'Precondition Required',
        pSource = '0',
        pCode = '0'
    ) {
...
class RequestHeaderFieldsTooLargeError extends BasicMessageError {
     ...
     */
    constructor(
        pMessage = 'Request Header Fields Too Large',
        pSource = '0',
        pCode = '0'
    ) {
...
class UnavailableForLegalReasonsError extends BasicMessageError {
     ...
     */
    constructor(
        pMessage = 'Unavailable For Legal Reasons',
        pSource = '0',
        pCode = '0'
    ) {
