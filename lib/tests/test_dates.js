...
test('\ndates scheduleToDate', t => {
    dates.locale('pt-BR');
    t.deepEqual(
        dates.scheduleToDate({ type: 'D', time: '08:30', workingDay: true }, dates.toDate('2001-01-01T00:00Z')),
        dates.toDate('2001-01-02T10:30:00.000Z')
    );
    t.deepEqual(
        dates.scheduleToDate({ type: 'M', time: '08:30', workingDay: true }, dates.toDate('2001-01-10T00:00Z')),
        dates.toDate('2001-02-01T10:30:00.000Z')
    );
    t.end();
});
