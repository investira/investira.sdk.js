...
test('\ndates holidays', t => {
    moment.locale('pt-BR');
    t.equal(dates.isHoliday(new Date('2019-05-01T23:59Z')), true);
    t.equal(dates.isHoliday(new Date('2019-04-21T23:59Z')), false);
    t.equal(dates.isHoliday(new Date('2019-11-11T23:59Z')), false);
    moment.locale('en-US');
    t.equal(dates.isHoliday(new Date('2019-05-01T23:59Z')), false);
    t.equal(dates.isHoliday(new Date('2019-04-21T23:59Z')), false);
    t.equal(dates.isHoliday(new Date('2019-11-11T23:59Z')), true);
    t.end();
});
