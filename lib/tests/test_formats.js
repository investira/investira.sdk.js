...
const { addDays, addMonths, addYears, daysBetween } = require('../utils/dates');
...
test('\nformats.friendlyDate', t => {
    ...
    t.equal(formats.friendlyDate(daysBetween(xDate, addYears(xDate, 1))), 'um ano');
    t.equal(formats.friendlyDate(daysBetween(xDate, addDays(addYears(xDate, 1), 1))), 'um ano e um dia');
    t.equal(formats.friendlyDate(daysBetween(xDate, addDays(addYears(xDate, 1), 5))), 'um ano e 5 dias');
    t.equal(formats.friendlyDate(daysBetween(xDate, addMonths(addYears(xDate, 1), 2))), 'um ano e 2 meses');
    t.equal(formats.friendlyDate(daysBetween(xDate, addMonths(addYears(xDate, 2), 1))), '2 anos e um mês');
    t.equal(formats.friendlyDate(daysBetween(xDate, addMonths(addYears(xDate, 2), 2))), '2 anos e 2 meses');
    //@ts-ignore
