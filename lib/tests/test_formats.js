...
test('\nformats.friendlyDate', t => {
    ...
    t.equal(formats.friendlyDate(366), '1 ano');
    t.equal(formats.friendlyDate(370), '1 ano e 4 dias');
    t.equal(formats.friendlyDate(430), '1 ano e 2 meses');
    t.equal(formats.friendlyDate(770), '2 anos e 1 mês');
