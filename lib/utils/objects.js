...
const objects = {
     ...
     * - retorna qualquer propriedade existente no objeto novo que não exista
     *   no objeto atual, independentemente do seu valor;
     * - retorna propriedades existentes nos dois objetos quando seus valores
     *   forem diferentes;
     * - null, undefined, string vazia, false, 0, arrays vazios e objetos vazios
     *   participam normalmente da comparação.
     *
    ...
    getMissingProperties: (pObjetoAtual, pObjetoNovo, pIncluirDiferentes = false) => {
         ...
         *
         * Utilizado no comportamento original da função, quando
         * pIncluirDiferentes for false.
         *
         ...
         *
         * Diferencia uma propriedade inexistente de uma propriedade
         * existente cujo valor seja undefined.
         *
         * @param {*} pObjeto Objeto a ser analisado.
         * @param {string} pChave Nome da propriedade.
         * @returns {boolean} true quando a propriedade existir no objeto.
         */
         ...
         * - 'null'
         *
         * A comparação das strings booleanas não diferencia maiúsculas
         * de minúsculas e desconsidera espaços nas extremidades.
         *
         ...
         * - equivalência entre valores booleanos;
         * - strings comparadas sem diferenciar maiúsculas de minúsculas;
         * - arrays comparados por conteúdo e ordem;
         * - objetos simples comparados recursivamente.
         *
         ...
         *
         * Quando pIncluirDiferentes for true, uma propriedade existente
         * em pNovo e inexistente em pAtual é considerada diferença,
         * independentemente do valor contido nela.
         *
        ...
        function pvComparar(pAtual, pNovo) {
            ...
            Object.keys(pNovo).forEach(pChave => {
                ...
                /*
                 * No modo de diferenças, uma propriedade existente somente
                 * no objeto novo já caracteriza diferença.
                 */
                ...
                /*
                 * Objetos simples são comparados recursivamente.
                 */
                if (pvEhObjeto(xValorNovoOriginal)) {
                    const xObjetoAtual = pvEhObjeto(xValorAtualOriginal) ? xValorAtualOriginal : {};
                ...
                /*
                 * Mantém o comportamento original quando não estiver
                ...
                /*
                 * No modo de diferenças, qualquer valor participa
                 * normalmente da comparação.
                 */
