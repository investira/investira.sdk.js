...
const dates = {
     ...
     * @param {Date} pDateEnd
     * @param {boolean} [pAbsolute=false]  Cálculo será efetuado:
     * - true: Retorna número inteiro considerando somente os meses, desprezando o valor dos dias. ex:
     * -- A quantidade de meses entre 2019-11-30 e 2019-12-01 será 1, mesmo o intervalo sendo de apenas 1 dia.
     * - false: Retorna número fracionário onde as casas decimais representam dias e o inteiro, meses
     * -- A quantidade de meses entre 2019-11-30 e 2019-12-01 será 0.033333333333333326.
     * @returns {number}
     */
    ...
    anniversary: (pAnniversaryDay, pTargetDate, pGreater = null) => {
        ...
        //Força inicio para janeiro
        const xDataBase = dates.startOf('day', BASE_DATE);
        //Soma anos a data base, depois soma dias e finalamente, meses
