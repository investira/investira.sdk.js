...
const dates = {
     ...
     * @returns
     */
    monthsBetween(pDate1, pData2) {
        //TODO: Refazer com moment e incluir os teste em test_dates.js
        throw Error(
            'Esta conta não representa meses, pois nem todos tem 30 dias. 28/fev até 28/março tem 1 mês'
        );
        // return Math.abs(pData2.getTime() - pDate1.getTime()) / dates.ONE_MONTH;
    },
